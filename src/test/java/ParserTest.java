...
public class ParserTest {
    ...
    public void parseStringToPhoneNumberValid() {
        ...
        String input = "+49 201 4511-333";

        PhoneNumber phoneNumber = parser.parseStringToPhoneNumberEx(input);

        assertNotNull(phoneNumber);
        assertEquals("+49 201 4511-333", phoneNumber.getOriginal());
        ...
        assertEquals("333", phoneNumber.getExtensionCode()); // Assuming no extension in this case
    }
